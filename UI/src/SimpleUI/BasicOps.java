...
public class BasicOps {
    ...
    void insert() throws SQLException {
        ...
        stmt.execute("INSERT INTO INFO VALUES(" + id + ",'"+username + "','"+password+ "','"+ name+"')");
        stmt.execute("commit");
    }
    ...
    void delete() throws SQLException {
        ...
        Scanner sc = new Scanner(System.in);
        id = sc.nextInt();
        stmt.execute("Delete from info where id=" + id);
        stmt.execute("commit");
    }
    ...
    void update() throws SQLException {
        ...
        name = sc.nextLine();
        name = sc.nextLine();
        stmt.executeQuery("update info set name='" + name + "' where id=" + id);
        stmt.execute("commit");
    }
